...
class AnimeBlogsControllerTest < ActionDispatch::IntegrationTest
  test "should create anime blog" do
    assert_difference('AnimeBlog.count') do
      post anime_blogs_path, params: {anime_blog: {anime_name: 'Death Note', desc: 'The story follows Light Yagami, a high school student who stumbles across a mysterious otherworldly notebook: the Death Note'}}
    end
